...
(4, '2023_04_12_180132_create_departments_table', 1),
(5, '2023_05_09_064828_create_topics_table', 1),
(6, '2014_10_12_000000_create_users_table', 2),
(7, '2023_05_11_052220_create_rooms_table', 3),
(8, '2023_12_03_071608_create_room_members_table', 4),
(9, '2023_12_10_062013_create_chats_table', 5),
(10, '2024_01_28_064048_create_notifications_table', 6),
(11, '2024_03_03_063843_create_topic_user_table', 6);
...
(1, 'Admin', NULL, 'admin@gmail.com', '01911223344', NULL, NULL, NULL, '$2y$10$NMShJJZr7uiug.gsoIworu4HKyBpduTDYoGi/JYwliHINORL0ada6', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL);
...
ALTER TABLE `rooms`
  ...
  ADD KEY `rooms_topic_id_foreign` (`topic_id`);
...
--
ALTER TABLE `rooms`
  ADD CONSTRAINT `rooms_topic_id_foreign` FOREIGN KEY (`topic_id`) REFERENCES `topics` (`id`) ON DELETE CASCADE,
